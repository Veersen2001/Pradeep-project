            ...
            {isLoggedIn ? (
              <li className="absolute bottom-4 w-[90%]">
                <div className="w-full flex md:flex-row flex-col gap-2 items-center justify-center">
                  <button className="btn-primary px-3.5 py-2.5 font-semibold rounded-md w-full bg-[#019cf9]">
                    <Link to="/user/profile">Profile</Link>
                  </button>
                  <button
                    className="btn-secondary px-3.5 py-2.5 font-semibold rounded-md w-full bg-[#d44136]"
                    onClick={onLogout}
                    disabled={isLoading}
                  >
